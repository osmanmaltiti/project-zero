...
export const LogIn = (props) => {
    ...
    return(
        <div id='signinform' className="bg-gradient-to-r from-gray-400 to-gray-50 shadow gap-4 mx-auto w-98p sm:w-4/5 rounded h-full flex flex-col py-8 
        md:w-96 md:absolute md:right-0 md:h-fit md:-top-36">
            <form id='signform' className="w-11/12 sm:w-4/5 mx-auto gap-2 flex flex-col" onSubmit={handleLogSubmit}>
...
export const SignUp = (props) => {
    ...
    return(
        <div className="bg-gradient-to-r from-gray-400 to-gray-50 shadow gap-4 mx-auto w-98p sm:w-4/5 rounded h-full flex flex-col py-8
        md:w-80 lg:w-96 md:absolute md:right-0 md:h-fit md:-top-56 2xl:-top-56 2xl:w-108">
            <form className="w-11/12 sm:w-4/5 mx-auto gap-2 flex flex-col" action='POST' onSubmit={handleRegSubmit}>
